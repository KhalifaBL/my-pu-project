...
const images = { Mathematics: 'http://jobinn.crunchpress.com/wp-content/uploads/2016/03/categories-icon-4.png'
...
if (found===0){
     ...
     el.innerHTML= '<div class="alert alert-danger p-5 text-center "> No ' +service + ' professors yet  in  ' + serviceLocation + ' </div>' ;
